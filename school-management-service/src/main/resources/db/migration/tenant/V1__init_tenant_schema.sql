...
CREATE UNIQUE INDEX uq_term_current_per_year
...
CREATE INDEX idx_student_fees_reminder
    ON student_fees (last_reminder_sent_at)
...
CREATE INDEX idx_student_fees_due_date
